The Sensor Data namespace defines the following elements that can be sent in stanzas. The 
...
the entity making the corresponding request. Both the Sensor Client and Sensor Server 
entities are XMPP clients. The Sensor Data namespace is primarily intended for connected 
