...
| [Mastering Internet of Things](https://github.com/PeterWaher/MIoT)                                               | C#       | .NET Core/UWP | Multiple IoT-related projects implementing sensors, actuators, controllers and concentrators using a variety of common IoT protocols, including Neuro-Foundation interfaces.                                       |
| [Open Weather Map Sensor](https://github.com/PeterWaher/OpenWeatherMapSensor)                                    | C#       | .NET Core/UWP | Example sensor project showing how to integrate a back-end API providing sensor information to act as a real-time sensor on a harmonized internetwork.                                                             |
