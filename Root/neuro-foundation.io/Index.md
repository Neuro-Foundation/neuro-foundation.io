...
| TAG Legal Lab Windows Application                                                                                | C#       | Windows       | [GitHub](https://github.com/Trust-Anchor-Group/LegalLab)                                    | Windows Application allowing you to design, create, sign and propose smart contracts, using Neuro-Foundation interfaces.                                                                                           |
| TAG white-label Xamarin App                                                                                      | C#       | Android, iOS  | [GitHub](https://github.com/Trust-Anchor-Group/XamarinApp)                                  | Simple Smart Phone App, utilizing Neuro-Foundation interfaces for digital identities, smart contracts, as well as interacting with others and devices                                                              |
| [TAG white-label ID App](https://lab.tagroot.io/Downloads/com.tag.IdApp.apk)                                     | C#       | Android, iOS  | [GitHub](https://github.com/Trust-Anchor-Group/IdApp)                                       | Smart Phone App, utilizing Neuro-Foundation interfaces for digital identities, smart contracts, as well as interacting with others and devices. Extens the Xamarin App.                                            |
