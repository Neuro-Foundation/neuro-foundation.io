...
| TAG Legal Lab Windows Application                                                                                | C#       | Windows       | [GitHub](https://github.com/Trust-Anchor-Group/LegalLab)                                    | Windows Application allowing you to design, create, sign and propose smart contracts, as defined in IEEE P1451.99                                                                                                  |
| TAG white-label Xamarin App                                                                                      | C#       | Android, iOS  | [GitHub](https://github.com/Trust-Anchor-Group/XamarinApp)                                  | Simple Smart Phone App, utilizing IEEE P1451.99 for digital identities, smart contracts, as well as interacting with others and devices                                                                            |
| [TAG white-label ID App](https://lab.tagroot.io/Downloads/com.tag.IdApp.apk)                                     | C#       | Android, iOS  | [GitHub](https://github.com/Trust-Anchor-Group/IdApp)                                       | Smart Phone App, utilizing IEEE P1451.99 for digital identities, smart contracts, as well as interacting with others and devices. Extens the Xamarin App.                                                          |
...
| [OpenWeatherMapSensor](https://github.com/PeterWaher/OpenWeatherMapSensor)            | C#       | UWP         | Simple Sensor that maps a backend interface (here, using Open Weather Map API) to 1451.99. Example runs on Windows 10 IoT on Raspberry Pi with Arduino.                                                                                                                          |
