...
| `authorizeAccess`              | `iq set`    | ==>        | Required          |                 |
| `getNetworkIdentity`           | `iq get`    |            | Required          | <==             |
| `reviewIdProviders`            | `iq get`    | ==>        | Required          |                 |
| `selectReviewService`          | `iq set`    | ==>        | Required          |                 |
| `readyForApproval`             | `iq set`    | ==>        | Required          |                 |
