The [Peer-to-Peer communication namespace](Schemas/P2P.xsd) [defines](P2P.md) the following 
...
making the corresponding request. All Peers are XMPP clients. The Peer-to-Peer communication
