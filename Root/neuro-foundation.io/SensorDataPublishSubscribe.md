...
<iq from='client@example.org/1234' type='set' id='pub1'>
  <pubsub xmlns='http://jabber.org/protocol/pubsub'>
    <publish node='urn:nfi:iot:sd:1.0'>
      <item>
...
3.  Publishes support for the feature `urn:nfi:iot:sd:1.0+notify`.
