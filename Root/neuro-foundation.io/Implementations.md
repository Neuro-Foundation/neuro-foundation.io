...
| [IoTBridgeHttp](https://github.com/Neuro-Foundation/IoTBridgeHttp)                    | C#       | .NET Core   | Application that allows external devices POST sensor data to the harmonized network using HTTP `POST`.                                                                                                                                                                           |
